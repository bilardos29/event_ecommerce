...
List<MyEOSubGroupModel> listMyEOSubGroup = [
      ...
      MyEOSubGroupModel(groupId: 0, id: 3, name: 'MyEO Running'),
      MyEOSubGroupModel(groupId: 0, id: 4, name: 'MyEO Royal Flush'),
      MyEOSubGroupModel(groupId: 0, id: 5, name: 'MyEO Pilates/Yoga'),
      ...
      MyEOSubGroupModel(groupId: 1, id: 12, name: 'MyEO Parenting'),
      ...
      MyEOSubGroupModel(groupId: 2, id: 17, name: 'MyEO Technology'),
    ];
